...
<table style="margin-left: auto; margin-right: auto;" border="2" width="650" 
    ...
    <td width="209">
    	<input class="wrap2" type="text" id="ap_dname" name="ap_dname" style=" height:50px;line-height: 75px; width:98%; border: 0;"disabled>
    </td>
    </tr>
  	<tr>
    ...
    <td colspan="3">
    <textarea class="wrap2" id="ap_content"name="ap_content" style=" border:0; line-height:2; width:99%;" cols="60" rows="4" disabled></textarea>
    </td>
    </tr>
    <tr>
